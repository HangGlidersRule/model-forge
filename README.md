...
| **Qwen-Image-2.1** (diffusion) | [`Qwen/Qwen-Image-2.1`](https://huggingface.co/Qwen/Qwen-Image-2.1) (external, Qwen Research License) | [`Darkstar-Qwen-Image-2.1-Base-ModelOpt-W4A4-NVFP4`](https://huggingface.co/HangGlidersRule/Darkstar-Qwen-Image-2.1-Base-ModelOpt-W4A4-NVFP4) + [`-FP8`](https://huggingface.co/HangGlidersRule/Darkstar-Qwen-Image-2.1-Base-ModelOpt-FP8) | not shipped — behavior-cell gate (see [governance](docs/governance/model-family-onboarding.md)) | not shipped — behavior-cell gate | — | [`models/qwen-image-2.1/`](models/qwen-image-2.1/) |
